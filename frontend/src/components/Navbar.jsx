...
const Navbar = () => {
  ...
  return (
    <div className='flex items-center justify-between text-sm py-4 mb-5 border-b border-b-gray-400'>
        ...
        <img onClick={()=>setShowMenu(true)} className='md:hidden w-6' src={assets.menu_icon}/>
        {/* Mobile Menu */}
        <div className={`${showMenu ? 'fixed w-full':'hidden'} right-0 top-0 bottom-0 z-20 overflow-hidden bg-white transition-all`}>
